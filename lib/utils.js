...
export const getPriceString = (price) => `$${parseInt(price)} CDN`

export const insertAt = (array, item, index) => [
  ...array.slice(0, index),
  item,
  ...array.slice(index + 1),
]

const langOnly = (lang) => (currentLang) => ({
  'mobile:hidden': currentLang !== lang,
})

export const frOnly = langOnly('fr')
export const enOnly = langOnly('en')
